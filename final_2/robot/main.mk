...
OBJS=main.o serial.o startup.o newlib_stubs.o joystick.o board.o collision_detector.o field_sensor_adc.o hbridge_motor.o robot_auto_mode.o vl53l0x.o
...
joystick.o: joystick.c
	$(CC) -c $(CCFLAGS) joystick.c -o joystick.o

board.o: board.c
	$(CC) -c $(CCFLAGS) board.c -o board.o

collision_detector.o: collision_detector.c
	$(CC) -c $(CCFLAGS) collision_detector.c -o collision_detector.o

field_sensor_adc.o: field_sensor_adc.c
	$(CC) -c $(CCFLAGS) field_sensor_adc.c -o field_sensor_adc.o

hbridge_motor.o: hbridge_motor.c
	$(CC) -c $(CCFLAGS) hbridge_motor.c -o hbridge_motor.o

robot_auto_mode.o: robot_auto_mode.c
	$(CC) -c $(CCFLAGS) robot_auto_mode.c -o robot_auto_mode.o
